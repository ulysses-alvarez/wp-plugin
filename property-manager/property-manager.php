...
require_once PROPERTY_MANAGER_PATH . 'includes/class-property-user-fields-customization.php';
...
function property_manager_init() {
    ...
    // Initialize user fields customization
    Property_User_Fields_Customization::init();
