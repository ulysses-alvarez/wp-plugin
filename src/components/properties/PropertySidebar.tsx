  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          ...
          {mode === 'view' && property && (
            <div className="space-y-6">
              ...
              {/* Price Card */}
              <div className="bg-gradient-to-br from-primary-light to-white border-2 border-primary rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                {property.google_maps_url && (
                  <a
                    ...
                    className="flex items-center justify-between gap-3 bg-white border border-gray-200 rounded-lg px-4 py-3 hover:border-primary hover:bg-primary-light transition-all duration-200 shadow-sm group"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-primary-light rounded-lg flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                ...
                {property.attachment_id && (
                  <button className="w-full flex items-center justify-between gap-3 bg-white border border-gray-200 rounded-lg px-4 py-3 hover:border-primary hover:bg-primary-light transition-all duration-200 shadow-sm group">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-primary-light rounded-lg flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                        <svg className="w-5 h-5 text-primary group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm font-medium text-gray-900">Descargar Ficha Técnica</span>
                    </div>
                    <svg className="w-4 h-4 text-gray-400 group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* View Mode Footer */}
        {mode === 'view' && property && (
          <div className="flex-shrink-0 bg-gradient-to-t from-gray-50 to-white border-t border-gray-200 px-6 py-4 flex gap-3">
            {canEdit && onEdit && (
              <button
                onClick={() => onEdit(property)}
                className="flex-1 px-4 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-hover transition-all duration-200 font-medium flex items-center justify-center gap-2 text-sm shadow-sm hover:shadow-md"
              >
